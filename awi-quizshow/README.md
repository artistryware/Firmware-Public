...
This firmware was created using the older expansion boards. The new expansions boards only provide sight (8) inputs and outputs. The firmware needs to be modified for only four (4) buttons and indicators.
