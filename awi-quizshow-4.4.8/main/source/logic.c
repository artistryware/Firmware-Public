...
void logic_init()
{
    ...
    i2c_write(I2C_UE102_ADD, (uint8_t[]) CLEARLAMPS, 3);
...
void scan_task()
{
    while (true)
    {
        ...
        if (PLYR1(read)) {
            player = 1;
            i2c_write(I2C_UE102_ADD, (uint8_t[]) PLYR1FIRST, 3);
        }
        else if (PLYR2(read)) {
            player = 2;
            i2c_write(I2C_UE102_ADD, (uint8_t[]) PLYR2FIRST, 3);
        }
        else if (PLYR3(read)) {
            player = 3;
            i2c_write(I2C_UE102_ADD, (uint8_t[]) PLYR3FIRST, 3);
        }
        else if (PLYR4(read)) {
            player = 4;
            i2c_write(I2C_UE102_ADD, (uint8_t[]) PLYR4FIRST, 3);
        }
        else if (PLYR5(read)) {
            player = 5;
            i2c_write(I2C_UE102_ADD, (uint8_t[]) PLYR5FIRST, 3);
        }
        else if (PLYR6(read)) {
            player = 6;
            i2c_write(I2C_UE102_ADD, (uint8_t[]) PLYR6FIRST, 3);
        }
